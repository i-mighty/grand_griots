...
export default {
  ...
  checkboxBgColor: "#87CEEB",
  checkboxSize: 20,
  checkboxTickColor: "#fff",

  // Color
  // brandPrimary: platform === "ios" ? "#FFC300" : "#D69546",
  brandPrimary: platform === "ios" ? "#FFC300" : "#FFC500",
  brandInfo: "#87CEEB",
  brandSuccess: "#BDD999",
  brandDanger: "#F15E15",
  brandWarning: "#f0ad4e",
  ...
  toolbarBtnTextColor: platform === "ios" ? "#2C2C2C" : "#2C2C2C",
  toolbarDefaultBorder: platform === "ios" ? "#a7a6ab" : "#FFC500",
